...
class IRecetaRepository(Protocol):
    ...
    def obtener_receta_insumo_o_crear(self, receta_id: int, insumo_id: int, cantidad: float, unidad: str, unidad_cocina_id: int = None) -> RecetaInsumo: ...
...
class IPresentacionInsumoRepository(Protocol):
...
class IUnidadCocinaRepository(Protocol):
